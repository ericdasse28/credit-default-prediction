...
class TestRuledBasedPreprocessing:

    def test_missing_loan_interests_are_dropped(self):
    ...
    def test_rows_with_outlier_employment_lengths_are_dropped(self):
        """Given loan applications,
        When we preprocess them,
...
class TestInferedTransformers:

    def test_missing_person_emp_length_are_imputed(self):
        """Given loan applications,
        When we preprocess them,
